...
if __name__ == "__main__":
    ...
    points_horizontal = generate_hplane(x_range=(0, 10), y_range=(0, 10), num_points=num_points)
    save_to_xyz('horizontal_plane.xyz', points_horizontal)

    points_vertical = generate_vplane(x_range=(0, 10), z_range=(0, 10), num_points=num_points)
